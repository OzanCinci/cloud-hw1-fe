...
function PrivateLessons() {
    ...
    const handleDelete = (e,itemId) => {
        ...
        console.log(user)
        console.log(req);
        console.log('https://cloud-hw1-be.onrender.com/private-lessons/' + itemId);
        // This is a simple POST request with a JSON body.
        fetch('https://cloud-hw1-be.onrender.com/private-lessons/' + itemId, {
            method: 'DELETE', 
            headers: {
            'Content-Type': 'application/json',
            },
    ...
    const handleUpdate = (selectedItem) => {
        ...
        nav("/update/private-lessons/" + selectedItem._id);
        const btn = document.getElementById("close-button-private-lesson");
        if (btn)
            btn.click();
    }
